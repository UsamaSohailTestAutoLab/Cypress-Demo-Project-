Feature: Sample Feature
  Scenario: Verify Create Advance Project Functionality of Plannexe
    ...
    Then Select Project Type "Simple"
    ...
    Then Checked "Revenue" and Amount "20"
    Then Checked "Cost" and Amount "20"
    Then Checked "Efforts" and Amount "20"
    Then Checked "Points" and Amount "20"
